...
localparam 
    INIT_IDLE           = 4'd0,
    INIT_DELAY10MS      = 4'd1,//等待10ms
    INIT_CMD0           = 4'd2,//初始化命令 同时保持 sddat3 信号为高电平
    INIT_CMD8           = 4'd3,//鉴别 SD1.X 和 SD2.0
    INIT_ACMD41         = 4'd4,//区分出卡的三种类型：SD 1.X卡、SD 2.0 非大容量卡、SDHC 2.0 大容量卡
    INIT_CMD2           = 4'd5,//获取CID寄存器
    INIT_CMD3           = 4'd6,//要求card指定一个RCA
    INIT_CMD7           = 4'd7,//选中卡 
    INIT_CMD16          = 4'd8,//设置 block length 一般512B
    INIT_DOWN           = 4'd9;
    ...
    if(~rst_n)begin
        ...
        case(state)
            ...
            INIT_CMD0:begin
                ...
                else if(delay_cnt == 'd64000)begin
                    delay_cnt   <= 'd0;
            ...
            INIT_ACMD41:begin
                if(delay_cnt == 'd0)begin
                    cmd_para_reg<= {6'd55,32'h00000000};
                    o_tx_en     <= 'd1;
                    delay_cnt   <= delay_cnt + 'd1;
                    state       <= INIT_ACMD41;
                end
